...
import com.twx.clock.service.VideoLiveWallpaper
import com.twx.clock.topfun.showDialog
import com.twx.clock.ui.adapter.recyclerview.SettingAdapter
import com.twx.clock.ui.adapter.recyclerview.SettingBottomAdapter
            ...
            when (position) {
                ...
                in 2..3 -> {
                    toOtherActivity<DealViewActivity>(
                        this,
                        false
                    ) { putExtra(com.twx.module_base.util.Constants.SET_Deal1, position) }
                }
