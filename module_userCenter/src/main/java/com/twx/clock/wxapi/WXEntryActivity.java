...
public class WXEntryActivity extends BaseViewActivity implements IWXAPIEventHandler, IWeChatCallback {
    ...
    public void onWxLoginSuccess(LoginBean loginBean) {
        ...
        if (ret == 200) {
            ...
            LogUtils.i( "-------onWxLoginSuccess---------------->：" + loginBean.getMsg());
        }
